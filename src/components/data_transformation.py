...
class DataTransformation:
        ...
        try:
            ...
            cat_pipeline=Pipeline(
                steps=[
                    ...
                    ("one_hot_encoder",OneHotEncoder(handle_unknown="ignore",   # ← this is key
    sparse_output=False, )),
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("We have loaded the train and test dataset")

            logging.info("Now lets get that object we used for preprocessing")
